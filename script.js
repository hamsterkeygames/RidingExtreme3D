document.addEventListener('DOMContentLoaded', () => {
    ...
    for (let i of gameSelect.options) {
        if (i.value == GAME_PAGE) {
            i.selected = true
            document.getElementById('gamePage').innerText = i.innerText
        }
    ...
    telegramChannelBtn.addEventListener('click', () => {
        window.open('https://t.me/crypto_experimenty', '_blank');
    });
